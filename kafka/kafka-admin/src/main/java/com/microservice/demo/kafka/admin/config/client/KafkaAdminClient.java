...
public class KafkaAdminClient {
    ...
    private CreateTopicsResult doCreateTopics(RetryContext retryContext) {
        ...
        List<NewTopic> kafkaTopics = topicNames.stream().map(topic -> new NewTopic(topic.trim(), kafkaConfigData.getNumOfPartitions(), kafkaConfigData.getReplicationFactor())).collect(Collectors.toList());
